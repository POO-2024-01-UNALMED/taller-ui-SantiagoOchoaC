...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	            ...
	            if ("/*-+".contains(value)) {
	            	...
	            	if (operator == null) {
	            	    if (number1 == null) {
	            	        ...
	            	        number1 += value; // SE AGREGA POR LA PRIMERA ASIGNACIÓN DE LAS VARIABLES "". 
	            	    }
	            	    ...
	            	    if (number2 == null) {
	            	        ...
	            	        number2 += value; // SE AGREGA POR LA PRIMERA ASIGNACIÓN DE LAS VARIABLES "" Y PERMITE NUMEROS DE n DIGITOS. 
	            	    }
	...
	public String operar(String number1, String number2, String operador) {
